...
export const ResponsiveTest = () => {
  ...
  return (
    <div className={`flex flex-col h-screen bg-gray-50 ${getViewportClass()}`}>
      {/* Navigation */}
      <Navigation />
      ...
      <div className="bg-white border-b border-gray-200 px-4 py-3 md:px-6">
        <div className="flex flex-wrap items-center gap-2">
          ...
          <div className="flex gap-2 flex-wrap">
            {['full', '320px', '375px', '768px'].map((size) => (
              <button
                key={size}
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-col gap-2">
              <button
                ...
                className="w-full px-3 py-2 sm:w-auto bg-primary-600 text-white rounded-md hover:bg-primary-700 transition-colors font-medium text-sm"
              ...
              <button
                ...
                className="w-full px-3 py-2 sm:w-auto bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors font-medium text-sm"
      ...
      <Modal
        ...
        title="Responsive Design Test Info"
